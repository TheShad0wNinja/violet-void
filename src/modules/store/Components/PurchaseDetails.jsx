  ...
  return (
    <div className="md:w-[25%] sm:w-full h-fit top-20 sticky mt-5 ">
      <div className="bg-secondary-dark  rounded-2xl">
        <div className="md:text-2xl  font-bold bg-secondary-light w-fit p-2 pr-8 rounded-br-full">
          Game Name
        </div>
        <div className="p-8">
          <div className="flex  items-center justify-between">
            ...
            <div className="flex items-center relative space-x-[-10px]">
              <img src={pfp1} className="w-10 h-10 rounded-full border-2 border-secondary-dark" />
              <img src={pfp2} className="w-10 h-10 rounded-full border-2 border-secondary-dark z-10" />
              <img src={pfp3} className="w-10 h-10 rounded-full border-2 border-secondary-dark z-20" />
            </div>
          </div>

...
function AccountPage() {
  ...
  // Calculate total hours in days for display
      ...
      >
        <div className="flex h-full w-full items-center justify-center">
          ...
          <div className="flex h-full w-1/2 flex-col items-center justify-center gap-5 rounded-2xl">
            <div className="flex h-1/3 w-[85%] flex-col items-end gap-2">
              <button
                onClick={() => {
            ...
            <div className="bg-secondary-900 flex h-1/6 w-[85%] items-center justify-between rounded-2xl shadow-md shadow-gray-950">

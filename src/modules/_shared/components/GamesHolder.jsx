...
import GameHolderBox from "./GameHolderBox";
...
function GamesHolder({ Sectionname }) {
  ...
  return (
    <div>
      ...
      <div className={`flex gap-3 transition-all duration-300 ease-in-out ${fade ? "opacity-0 translate-y-3" : "opacity-100 translate-y-0"}`}>
